...
public class OrderDaoImpl implements IOrderDao {
	...
	public List<Order> findPage(String cname, String orderNum, Integer orderType, Integer index, Integer currentCount)
		...
		return qr.query(sql, new BeanListHandler<>(Order.class), "%" + cname + "%", orderType, orderNum, index,
				currentCount);
	}

	@Override
	public List<Order> findPage(String cname, Integer orderType, Integer index, Integer currentCount)
			throws SQLException {
		QueryRunner qr = new QueryRunner(DruidConnection.getDataSource());
	...
	@Override
	public List<Order> findPageByorderNum(String orderNum, Integer orderType, Integer index, Integer currentCount)
			throws SQLException {
		QueryRunner qr = new QueryRunner(DruidConnection.getDataSource());
